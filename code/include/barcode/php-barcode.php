...
$genbarcode_loc=dirname(__FILE__)."/"."genbarcode.exe";
 ...
 *
 *  returns(!) HTML-Code for barcode-image using html-code (using a table and with ../include/barcode/black.png and white.png)
 *
 *    text   : the text-line (<position>:<font-size>:<character> ...)
 *    bars   : where to place the bars  (<space-width><bar-width><space-width><bar-width>...)
 *    scale  : scale factor ( 1 < scale < unlimited (scale 50 will produce
...
function barcode_outhtml($code, $bars, $scale = 1, $total_y = 0, $space = ''){
    ...
    $out=
      ...
      '<tr><td><img src="../include/barcode/white.png" height="'.$space['top'].'" width="1" alt=" "></td></tr>'."\n".
      '<tr><td>'."\n".
      '<img src="../include/barcode/white.png" height="'.$height2.'" width="'.$space['left'].'" alt="#"/>';
	...
	if ($width){
	    $w=$val*$scale;
	    if ($w>0) $out.='<img src="../include/barcode/white.png" height="'.$total_y.'" width="'.$w.'" align="top" alt="" />';
	    $width=false;
	    continue;
	}
	if (preg_match("#[a-z]#", $val)){
	...
	$w=$val*$scale;
	if ($w>0) $out.='<img src="../include/barcode/black.png" height="'.$h.'" width="'.$w.'" align="top" />';
	$width=true;
    }
    $out.=
      '<img src="../include/barcode/white.png" height="'.$height2.'" width=".'.$space['right'].'" />'.
      '</td></tr>'."\n".
      '<tr><td><img src="../include/barcode/white.png" height="'.$space['bottom'].'" width="1"></td></tr>'."\n".
      '</table>'."\n";
