...
var ActionFooter, AssignmentBox, AssignmentSchoolyearsLine, AssignmentsTable, AssignmentsTableGradeEntry, Button, Input, LoadingIcon, React, StatusIcon, Table, classnames,
  __slice = [].slice;
...
AssignmentBox = React.createClass({
  ...
  handleSubmit: function(event) {
    ...
    return $.post('index.php?module=administrator|Schbas|BookAssignments|Generate', {
      data: this.state
    }).done((function(_this) {
