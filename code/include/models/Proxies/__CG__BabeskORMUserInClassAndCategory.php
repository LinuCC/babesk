 ...
 */
class UserInClassAndCategory extends \Babesk\ORM\UserInClassAndCategory implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'user', 'class', 'status', 'category');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (UserInClassAndCategory $proxy) {
