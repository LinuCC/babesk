 ...
 */
class ClassCategory extends \Babesk\ORM\ClassCategory implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'name', 'translatedName', 'usersInClassesAndCategories', 'classes');
        }
