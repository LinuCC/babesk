 ...
 */
class BabeskPriceGroups extends \Babesk\ORM\BabeskPriceGroups implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'name', 'max_credit', 'users');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (BabeskPriceGroups $proxy) {
    ...
    public function setMaxCredit($maxCredit)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setMaxCredit', array($maxCredit));

        return parent::setMaxCredit($maxCredit);
    }
    ...
    public function getMaxCredit()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getMaxCredit', array());

        return parent::getMaxCredit();
    }
