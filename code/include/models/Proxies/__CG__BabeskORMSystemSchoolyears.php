 ...
 */
class SystemSchoolyears extends \Babesk\ORM\SystemSchoolyears implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'label', 'active', 'usersInGradesAndSchoolyears');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (SystemSchoolyears $proxy) {
