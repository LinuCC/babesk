 ...
 */
class SystemSchoolSubject extends \Babesk\ORM\SystemSchoolSubject implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'abbreviation', 'name', 'books');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (SystemSchoolSubject $proxy) {
