	...
	switch ($action) {
		case 1: //register user
			if (isset($_POST['forename'], $_POST['name'], $_POST['username'])) {
				...
				try {
					$user_processing->RegisterUser($_POST['forename'], $_POST['name'], $_POST['username'], $_POST[
		...
		case 4:
			if (!isset($_POST['id'], $_POST['forename'], $_POST['name'], $_POST['username'], $_POST['credits'], $_POST[
				...
				if (isset($_POST['lockAccount'])) {
					$user_processing->ChangeUser($_GET['ID'], $_POST['id'], $_POST['forename'], $_POST['name'], $_POST[
