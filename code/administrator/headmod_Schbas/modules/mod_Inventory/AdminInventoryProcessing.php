...
class AdminInventoryProcessing {
	...
	function DeleteEntry($id) {
		...
		try {
			$inventoryManager->delEntry($id);										// die Inventardaten l�schen
			$loanManager->deleteAllEntriesWithValueOfKey("inventory_id", $id);		// die Ausleihdaten l�schen wir auch mit
		} catch (Exception $e) {
			$this->logs
			->log('ADMIN', 'MODERATE',
