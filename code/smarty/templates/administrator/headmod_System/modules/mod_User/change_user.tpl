...
<form action="index.php?section=System|User&action=4&ID={$user.ID}"
	...
	<fieldset>
		...
		<label>ID des Users:<input type="text" name="id" maxlength="10"
			...
			<button id="showccid" type="button" onclick="displayChangeCardId()">KartenID ver&auml;ndern</button>
			<button id="hideccid" type="button" onclick="resetCardId()" style="display:none">KartenID doch nicht ver&auml;ndern</button>
		...
		</label><br> <br> <label>Passwort &auml;ndern:<input type="password"
			name="passwd" />
		</label><br> <br> <label>Passwort&auml;nderung wiederholen:<input
	...
	<br>
	<fieldset>
		<legend>Identit&auml;tsinformationen</legend>
