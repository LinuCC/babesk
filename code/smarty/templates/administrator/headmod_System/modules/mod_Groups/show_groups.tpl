...
<table>
	...
	{foreach $groups as $group}
		<tr>
			...
			<td align="center"><form action='index.php?section=System|Groups&action=3&where={$group['ID']}' method='post'>
				<input type="submit" value='löschen'>
			</form></td>
			<td align="center"><form action='index.php?section=System|Groups&action=4&where={$group['ID']}' method='post'>
