<table>
	...
	<tbody>
		...
		<tr bgcolor='#FFC33'>
			...
			<form action="index.php?section=user&action=4&ID={$user.ID}" method="post"><input type='submit' value='bearbeiten'></form>
			<form action="index.php?section=user&action=3&ID={$user.ID}" method="post"><input type='submit' value='löschen'></form>
			</td>
		</tr>
		{/foreach}
	</tbody>
