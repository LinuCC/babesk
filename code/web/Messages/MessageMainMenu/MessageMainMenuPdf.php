...
class MessageMainMenuPdf {
	/////////////////////////////////////////////////////////////////////
	//Constructor
	/////////////////////////////////////////////////////////////////////

	public function __construct($title,$text,$class,$msgReturn,$mid,$uid) {
	...
	public function output() {
		$pdfName = sprintf('%s_%s_nachricht.pdf', $this->_mid, $this->_uid);
	...
	protected function barcodeCodeCreate() {
		...
		return sprintf('%s %s', $this->_mid, $this->_uid);
	}
	...
	protected function shouldBarcodePrint() {
		...
		return strcasecmp($this->_msgReturn, "shouldReturn") == 0;
	}
