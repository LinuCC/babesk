...
?>
    <div class="quizzy_result">
      ...
      <p>Du hast <span class="quizzy_result_score"><?php echo $score;?></span> von 
      <span class="quizzy_result_max"><?php echo $maxPossible;?></span> m&ouml;glichen Punkten erreicht!</p>
...
?>
      ...
      <?php } ?>
      <p class="quizzy_result_rank quizzy_result_rank_<?php echo $scoreRange->rank; ?>">Kennwort: <?php echo $scoreRange->rank; ?></p>
      <div class="quizzy_result_foot"><input type="submit" onclick="restartQuizzy();" value="Von vorne beginnen"></div>
    </div>
<?php
    return;
  }
...
<div class="quizzy_q_foot">
	<input type="submit" class="quizzy_q_foot_b" id="quizzy_q<?php echo $questNo ?>_foot_chk" value="&Uuml;berpr&uuml;fen">
	<input type="submit" class="quizzy_q_foot_b" id="quizzy_q<?php echo $questNo ?>_foot_nxt" value="Weiter">				
</div>